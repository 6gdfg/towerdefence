...
export const PLANT_ITEM_IDS = ['sunflower', 'bottleGrass', 'doubleBottleGrass', 'flameBottleGrass', 'puffShroom', 'fourLeafClover', 'boomerangLeaf', 'pentagram', 'pumpkinHead', 'machineGun', 'sniper', 'rocket', 'sunlightFlower', 'holyFlower', 'hotPepper', 'frostBlastShroom', 'cycloneShroom', 'windSailGrass', 'windWallGrass', 'magnetNeedle', 'electricFlower'] as const;
