...
export const CHAPTERS: ChapterSpec[] = [
  { id: 1, name: '火之晨曦', element: 'fire', elementLabel: '火元素', startLevel: 1, endLevel: 8 },
  { id: 2, name: '疾风凌云', element: 'wind', elementLabel: '风元素', startLevel: 9, endLevel: 16 },
  { id: 3, name: '金戈铁马', element: 'gold', elementLabel: '金元素', startLevel: 17, endLevel: 24 },
  { id: 4, name: '冰封万里', element: 'ice', elementLabel: '冰元素', startLevel: 25, endLevel: 32 },
  { id: 5, name: '紫电清霜', element: 'electric', elementLabel: '电元素', startLevel: 33, endLevel: 40 },
  { id: 6, name: '圣光普照', element: 'light', elementLabel: '光元素', startLevel: 41, endLevel: 48 },
];
