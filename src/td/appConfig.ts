...
export const PLANT_TYPES: PlantType[] = ['sunflower', 'bottleGrass', 'doubleBottleGrass', 'puffShroom', 'fourLeafClover', 'pentagram', 'pumpkinHead', 'machineGun', 'sniper', 'rocket', 'sunlightFlower', 'holyFlower', 'hotPepper', 'frostBlastShroom', 'cycloneShroom', 'magnetNeedle', 'electricFlower'];
